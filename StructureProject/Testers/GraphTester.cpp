...
//  StructureProject
//
//  Created by Phillips, Ryan on 3/18/19.
...
{
    puzzle.breadthFirstTraversal(puzzle, 9);
    cout << " " << endl;
...
void GraphTester :: findCheapestTraversal()
{
    ...
    cout << "The smallest cost is " << min << ", at index " << minIndex << endl;
}
