...
{
    //This is empty because the parent class contstructor handles it
}
...
template <class Type>
void Queue<Type> :: addedAtIndex(int index, Type item)
{
